...
namespace server.Controllers
{
    public partial class Api
    {
        ...
        //     {
        //         var userRegistration = SignUp_context.User.Find(request.Id);
        //
        ...
        //
        //         var calculatedHash =
        //             PasswordHelper.HashWithIterations(request.Password, userRegistration.R, userRegistration.N);
        //
        //         if (calculatedHash.SequenceEqual(request.Hash))
        //         {
        //             var salt = PasswordHelper.GenerateSalt();
        //             var hash = PasswordHelper.HashWithIterations(request.Password, salt, userRegistration.N + 1);
        //
        //             var newUser = new server.Mysql.Models.User
        //             {
        //                 Account = userRegistration.Account,
        //                 Pass = hash,
        //                 Salt = salt,
        //                 Status = 0,
        //                 RevertPass = new byte[256],
        //                 N = userRegistration.N,
        //                 R = userRegistration.R
        //             };
        //
        //             SignUp_context.User.Add(newUser);
        //             SignUp_context.SaveChanges();
        //
        //             TypeLog(newUser.Account, "Signup", true, $"{request.id} ", false, "注册成功，等待管理审核。");
        //             return Ok("注册成功，等待管理审核。");
        //         }
        //         else
        //         {
        //             return BadRequest("Invalid password hash.");
        //         }
        //     }
    }
