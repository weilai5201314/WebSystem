...
public partial class Api
{
    ...
    public IActionResult WriteFile([FromBody] FileAccessRequest request)
    {
        ...
        try
        {
            ...
            if (user == null)
            {
                TypeLog(request.UserName, "WtiteFile", true, $"FileName:{request.ObjectName1}", false,
                    "Invalid username");
            ...
            {
                TypeLog(request.UserName, "WriteFile", true, $"FileName:{request.ObjectName1}", false,
                    "File already exists");
            ...
            if (!HasPermission(user.ID, request.ObjectName1, 2) && !HasPermission(user.ID, request.ObjectName1, 4))
            {
                ...
                return BadRequest("You do not have permission to write this file");
            }
            //---------------------------------------------------自主访问控制---------------------------------------------------//
            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            TypeLog(request.UserName, "WriteFile", true, $"FileName:{request.ObjectName1}", true,
